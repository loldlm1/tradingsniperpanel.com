ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Tradingsniperpanel Com"
  ...
  config.register_stylesheet "https://code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css"
  config.register_stylesheet "active_admin.css", media: "all"

  config.clear_javascripts!
  config.register_javascript "https://code.jquery.com/jquery-3.7.1.min.js"
  config.register_javascript "https://code.jquery.com/ui/1.13.2/jquery-ui.min.js"
