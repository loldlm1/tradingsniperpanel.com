...
RSpec.describe MarkdownRenderer do
  describe ".render" do
    it "embeds local video tokens as inline video" do
      ...
      expect(html).not_to include(" muted")
      expect(html).not_to include(" loop")
    end
    ...
    it "embeds youtube tokens as iframes" do
      ...
      expect(html).to include("playsinline=1")
      expect(html).not_to include("autoplay=1")
      expect(html).not_to include("allow=\"accelerometer; autoplay;")
    end
