module DashboardNavigationHelper
  ...
  GROUP_ACTIVE_BG = "bg-teal-500/10 dark:bg-teal-500/20".freeze
  ...
  def mosaic_sidebar_icon_classes(active:)
    active ? "shrink-0 fill-current text-teal-600 dark:text-teal-400" : "shrink-0 fill-current text-gray-400 dark:text-gray-500"
  end
