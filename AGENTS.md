...
- **Reference docs**: see `docs/database_model_reference.md` for the data model/API surface and use the project skill at `.agents/skills/mosaic-html-rails` for Mosaic dashboard/account/auth frontend work. Landing/marketing pages still follow the template selected by `LANDING_TEMPLATE`.
